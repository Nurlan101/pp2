...
class Rhombus(GameObject):
    ...
    def draw(self):
        ...
        side_len = math.pow((x2 - x1) ** 2 + (y2 - y1) ** 2, 0.5)  # Rhombus proportions
        #
        vertex_1 = (x1, y1)  #
        vertex_2 = (x2, y2)  #
    ...
    def handle(self, mouse_pos):  # Controlling the size with mouse
        self.end_pos = mouse_pos  #


def main():
    Points_P = [(28, 10), (12, 50)]  # Icons location
    ...
    switch_pen = Button(Points_P, 5)  # Icons
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                for key in buttons_dict.keys():  # Detects collision between mouse and icons
